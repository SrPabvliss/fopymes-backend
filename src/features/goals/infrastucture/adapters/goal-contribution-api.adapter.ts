...
export class GoalContributionApiAdapter {
  static toApiResponse(contribution: IGoalContribution): z.infer<typeof selectGoalContributionSchema> {
    return {
      id: contribution.id,
  ...
  static toApiResponseList(contributions: IGoalContribution[]): z.infer<typeof selectGoalContributionSchema>[] {
